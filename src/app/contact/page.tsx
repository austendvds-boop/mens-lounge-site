          ...
          <MotionReveal delayMs={140}>
            <div className="motion-surface mt-12 rounded-xl2 border border-brand-navy/15 bg-brand-cream/40 p-6 md:p-8">
              ...
              <form action={CONTACT_FORM_ENDPOINT} method="POST" className="mt-6 grid gap-4">
                ...
                <button
                  type="submit"
                  className="motion-surface mt-2 inline-flex w-fit items-center justify-center rounded-full bg-cta-green px-6 py-3 text-sm font-semibold text-white transition hover:bg-cta-green/90 active:scale-[0.99]"
                >
                  Send Message
                </button>
              </form>
