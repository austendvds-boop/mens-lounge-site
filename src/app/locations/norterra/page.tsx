          ...
          <div>
            ...
            <div className="mt-8 space-y-6 rounded-xl2 border border-brand-navy/15 bg-brand-cream/60 p-6">
              ...
              <div>
                ...
                <a href={norterra.phoneHref} className="mt-2 block font-semibold text-brand-navy hover:underline">
                  {norterra.phoneDisplay}
                </a>
                <a href={`mailto:${norterra.email}`} className="block text-brand-slate hover:underline">
                  {norterra.email}
                </a>
              </div>
