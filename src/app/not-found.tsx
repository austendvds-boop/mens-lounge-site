  ...
  return (
    <section className="bg-brand-cream py-20 md:py-28">
      <div className="container-shell">
        <div className="mx-auto max-w-2xl rounded-xl2 border border-brand-navy/15 bg-white p-8 text-center shadow-card md:p-12">
          <p className="text-sm font-semibold uppercase tracking-[0.2em] text-brand-gold">Page not found</p>
          <h1 className="mt-4 text-3xl font-extrabold md:text-4xl">That page is not here.</h1>
          ...
          <p className="mt-6 text-sm text-brand-slate">
            ...
            <a className="font-semibold text-brand-navy underline-offset-4 hover:underline" href="tel:+16235563193">
              (623) 556-3193
            </a>
            .
          </p>
