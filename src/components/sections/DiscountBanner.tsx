...
export function DiscountBanner() {
  return (
    <section className="bg-brand-navy py-10 text-white">
      <div className="container-shell flex flex-col gap-4 rounded-xl2 border border-brand-gold/35 bg-brand-navy px-6 py-8 md:flex-row md:items-center md:justify-between">
